                    ...
                    @foreach ($category->menus as $menu)
                        <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
                            ...
                            <div class="px-6 py-4">
                                ...
                                <p class="mb-2 text-gray-700">{{ $menu->description }}</p>
                                <p class="mb-2 text-gray-700">Category: {{ $category->name }}</p> <!-- Category Name -->
                                <p class="text-xl text-green-600">${{ $menu->price }}</p>
                            </div>
                            <div class="flex items-center justify-between p-4">
                                <div>
                                    ...
                                    <form action="" method="POST">
                                        @csrf
                                        <button type="submit"
                                            class="bg-green-500 hover:bg-blue-700 text-black font-bold py-2 px-4 rounded">
                                            Add to Cart
                                        </button>
                                    </form>
                                </div>
